...
public class Enneagone {
	private Point pa,pb,pc,pd,pe,pf,pg,ph,pi;
	...
	public Enneagone(Point pa, Point pb, Point pc, Point pd, Point pe, Point pf, Point pg, Point ph, Point pi) {
		this.pa = pa;
		this.pb = pb;
		this.pc = pc;
		this.pd = pd;
