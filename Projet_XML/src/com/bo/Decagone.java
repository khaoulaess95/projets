...
public class Decagone {
	private Point pa,pb,pc,pd,pe,pf,pg,ph,pi,pj;
	...
	public Decagone(Point pa, Point pb, Point pc, Point pd, Point pe, Point pf, Point pg, Point ph, Point pi,
			Point pj) {
		this.pa = pa;
		this.pb = pb;
		this.pc = pc;
